...
> = {
  ...
  [QUIZ_TYPE.WORDLE_DA_LIGA]: MESSAGE_TYPE.GET_LEAGUE_HUMANS_FOR_MINIGAME,
  [QUIZ_TYPE.ARTILHEIRO_DA_RODADA]: MESSAGE_TYPE.GET_TOP_SCORERS_FOR_MINIGAME,
  [QUIZ_TYPE.CONEXOES_DA_LIGA]: MESSAGE_TYPE.GET_LEAGUE_HUMANS_FOR_MINIGAME,
  [QUIZ_TYPE.QUEM_JOGA_NO_CLUBE]: MESSAGE_TYPE.GET_LEAGUE_HUMANS_FOR_MINIGAME,
  [QUIZ_TYPE.TIME_ESTADIO]: MESSAGE_TYPE.GET_STADIUMS_FOR_MINIGAME,
}
